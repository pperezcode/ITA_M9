...
public class AppController {
	...
	public void iniciaApp() {
		...
		// Demanar potència objectiu
		
		int potObj = cv.demanarPotenciaObj();
		
		cv.mostrarMissatge("Activant coets per assolir la nova potència objectiu: " + potObj + "\n...");
		
		// Setegem la potència objectiu de tots els propulsors a la nova potObj
